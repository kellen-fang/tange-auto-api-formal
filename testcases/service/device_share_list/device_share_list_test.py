...
# FROM: testcases/service/device_share_list/device_share_list.yml
...
class TestCaseDeviceShareList(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            ...
            .extract()
            .with_jmespath("body.data[0].phone", "phone")
            .with_jmespath("body.data[0].email", "email")
            .validate()
...
if __name__ == "__main__":
    TestCaseDeviceShareList().test_start()
