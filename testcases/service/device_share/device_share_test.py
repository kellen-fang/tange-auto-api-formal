...
# FROM: testcases/service/device_share/device_share.yml
...
class TestCaseDeviceShare(HttpRunner):
    ...
    config = Config("设备分享").base_url("${ENV(api_url)}")
...
if __name__ == "__main__":
    TestCaseDeviceShare().test_start()
