...
# FROM: testcases/service/service_information/service_information.yml
...
class TestCaseServiceInformation(HttpRunner):
    ...
    config = Config("服务查询").base_url("${ENV(api_url)}")
...
if __name__ == "__main__":
    TestCaseServiceInformation().test_start()
