...
# FROM: testcases/service/shop_index/shop_index.yml
...
class TestCaseShopIndex(HttpRunner):
    ...
    config = Config("tange-iCam365-我的云录像服务").base_url("${ENV(api_url)}")
    ...
    teststeps = [
        ...
        Step(
            RunRequest("我的云录像服务")
            .get(
                "/shop/index?user_id=$id&device_id=$device_id&language=$language&pkgname=$pkgname&token=$token&version=$version&platform=$platform"
            )
