...
# FROM: testcases/service/shop_sim/shop_sim.yml
...
class TestCaseShopSim(HttpRunner):
    ...
    config = Config("tange-iCam365-我的包看服务").base_url("${ENV(api_url)}")
    ...
    teststeps = [
        ...
        Step(
            RunRequest("我的包看服务")
            .get(
                "/shop/sim?user_id=$id&device_id=$device_id&language=$language&pkgname=$pkgname&token=$token&version=$version&platform=$platform"
            )
