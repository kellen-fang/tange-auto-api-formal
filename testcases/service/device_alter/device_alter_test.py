...
# FROM: testcases/service/device_alter/device_alter.yml
...
class TestCaseDeviceAlter(HttpRunner):
    ...
    config = Config("修改设备名称").base_url("${ENV(api_url)}")
...
if __name__ == "__main__":
    TestCaseDeviceAlter().test_start()
